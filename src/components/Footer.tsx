    ...
    <footer className="border-t border-[#1a1a1a] bg-[#000000]">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[12px] font-semibold text-[#B8BCC8]">
                FHEVM<span className="text-[#3A3D47]">.bootcamp</span>
              </span>
            </div>
            <p className="mt-3 text-[12px] leading-relaxed text-[#3A3D47]">
          ...
          {/* Curriculum */}
          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-widest text-[#5A5F73]">
              Curriculum
            </h4>
            <ul className="mt-3 space-y-2">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-[12px] text-[#3A3D47] transition hover:text-[#FFC517]">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              {[
                ...
                <li key={l.href}>
                  <a href={l.href} target="_blank" rel="noopener noreferrer" className="text-[12px] text-[#3A3D47] transition hover:text-[#FFC517]">
                    {l.label}
                  </a>
                </li>
              ))}
