  ...
  return (
    <div className="mx-auto min-h-screen max-w-5xl px-6 pt-24 pb-20">
      <div className="mb-10 animate-fade-in-up">
        ...
        <h1 className="mt-3 text-2xl font-bold text-[#FFFFFF] md:text-3xl">Weekly Projects</h1>
      ...
      <div className="stagger grid gap-4 md:grid-cols-2">
        {WEEKS.map((week) => (
          ...
          >
            ...
            <h2 className="text-[15px] font-semibold text-[#FFFFFF] transition group-hover:text-[#FFC517]">
              {week.homework.title}
            </h2>
            <p className="mt-2 flex-1 text-[12px] text-[#C8C8C8]">
      ...
      <div className="mt-14 t-card animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
        ...
        <p className="mb-5 text-[13px] text-[#C8C8C8]">
        ...
        <div className="grid grid-cols-5 gap-2 text-center">
          {[
            ...
            <div
              key={g.grade}
              className="border border-[#1a1a1a] bg-[#111111] py-4 transition hover:border-[#2a2a2a]"
            >
              <div className="text-lg font-bold" style={{ color: g.color }}>{g.grade}</div>
              <div className="mt-1 text-[11px] text-[#C8C8C8]">{g.range}</div>
              <div className="text-[10px] text-[#808080]">{g.label}</div>
            </div>
          ))}
        </div>
      </div>
